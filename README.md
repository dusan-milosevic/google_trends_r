gtrendsR provides an interface for retrieving search terms provided by Google Trends. Hits value is between 1 and 100 (the most popular search term was in the time frame).
